...
"""Regression checks for the pinned GitHub Pages publication."""
...
SITE = ROOT / "site"
GUIDE_SHA256 = "59a55b2d8479014d01c988c79100d2968397c8d49122bba167e993d920ceaf55"


def test_pinned_guide_and_generated_companions_are_current():
    inventory, validation = _expected(
    ...
    assert decoded["guide_revision"] == "91c6790"
    assert decoded["command_count"] == 38
    assert decoded["argument_declaration_count"] == 205
    assert decoded["commands_with_admitted_subset"] == 2
